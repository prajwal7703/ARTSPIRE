        ...
        <div style={{
          ...
          <div style={{ padding:"60px", display:"flex", justifyContent:"center", alignItems:"center" }}>
            <form onSubmit={handleSubmit} style={{ width:"100%", maxWidth:"400px", display:"flex", flexDirection:"column", gap:"20px" }}>
              ...
              <h1 style={{ textAlign:"center", fontSize:"38px", color:"#4f46e5", fontWeight:"bold", margin:0 }}>
                Welcome Back
              </h1>
              ...
              <p
                ...
                style={{ textAlign:"right", color:"#4f46e5", cursor:"pointer", fontWeight:600, fontSize:"14px", margin:"-8px 0 0" }}
              >
                Forgot password?
              </p>
              ...
              <div style={{ textAlign:"center", fontSize:"14px", color:"#94a3b8", fontWeight:600 }}>
                ...
                <span onClick={() => navigate("/register")} style={{ color:"#4f46e5", cursor:"pointer", fontWeight:800 }}>
                  Register
                </span>
              </div>
              ...
              <div style={{ textAlign:"center", fontSize:"13px", color:"#94a3b8" }}>
                Are you an artist?{" "}
                <span onClick={() => navigate("/artist-login")} style={{ color:"#f59e0b", cursor:"pointer", fontWeight:800 }}>
                  Artist Login →
                </span>
              </div>
...
const googleBtn = {
  padding: "16px", borderRadius: "50px", border: "1px solid #ddd",
  background: "white", fontSize: "17px", cursor: "pointer", fontWeight: "600",
};